...
if(form !== null) {
  ...
  form.addEventListener('submit', (e) => {
    e.preventDefault();
    console.log('Selected country:', form.querySelector('[name="Symptom1"]').value);
    console.log('Selected country:', form.querySelector('[name="Symptom2"]').value);
    console.log('Selected country:', form.querySelector('[name="Symptom3"]').value);
    console.log('Selected country:', form.querySelector('[name="Symptom4"]').value);
    console.log('Selected country:', form.querySelector('[name="Symptom5"]').value);
    console.log('Selected country:', form.querySelector('[name="Symptom6"]').value);
  });
}
